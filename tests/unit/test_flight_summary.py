...
from fr24sdk.resources.flight_summary import (
    FlightSummaryResource,
    _FlightSummaryParams
)
...
class TestFlightSummaryParams:
    ...
    def test_serialize_params(self):
        ...
        assert serialized["flight_datetime_from"] == test_datetime
        assert serialized["flight_datetime_to"] == test_datetime
...
class TestFlightSummaryResource:
    ...
    def test_get_light_success_with_datetime_range(self, flight_summary, mock_transport):
    ...
    def test_get_full_success(self, flight_summary, mock_transport):
        ...
        # Call the method
        result = flight_summary.get_full(
            flight_ids=["35f2ffd9"]
        )
